		<div class="footer text-center">
			<div class="footer__main col-12">
				...
				<p class="info mb-4 mb-lg-5 text-uppercase"><a href="tel:<?php the_field('phone_1', 'option'); ?>"><?php the_field('phone_2', 'option'); ?></a><br><?php the_field('address', 'option'); ?></p>
				<p class="social mb-0">
			...
			<div class="footer__bottom">
				...
				<div class="footer__bottom__info col-12 d-flex align-items-stretch justify-content-center">
					...
					<p class="mb-0"><div class="d-inline-block mr-1">&copy;</div><?php echo date("Y"); ?> DRIFTERS KITCHEN & BAR</p>
				</div>
			</div>
		</div>
	</div><!-- .main -->
